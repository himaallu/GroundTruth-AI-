...
Usage Steps
Launch: Run the script. A pop-up will ask for your Gemini API Key.

Select Data: A file picker will appear. Select Sample - Superstore.csv.

Processing: Watch the terminal as the script connects to the AI and runs the "Chain of Thought" prompt.

Save: A "Save As" dialog will appear. Save your report as Strategy_Report.pdf.
